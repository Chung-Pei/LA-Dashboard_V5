...
const CACHE_VERSION = 'la-dash-v6-202606110903';
const DATA_CACHE    = 'la-dash-data-v6-202606110903';
...
const APP_SHELL = [
  ...
  // 主應用邏輯
  './js/main.js',
  // 學習行為模組（版本釘定 ?v=202606110903）
  './js/chart-registry.js?v=202606110903',
  './js/behavior-loader.js?v=202606110903',
  './js/tab-behavior-radar.js?v=202606110903',
  './js/tab-behavior-correlation.js?v=202606110903',
  './js/tab-behavior-time.js?v=202606110903',
  './js/behavior-init.js?v=202606110903',
  './js/at-risk-report.js?v=202606110903',
  // CDN 備援（版本釘定）
  CHARTJS_URL,
];
