...
const CACHE_VERSION = 'la-dash-v6-202606110802';
const DATA_CACHE    = 'la-dash-data-v6-202606110802';
...
const APP_SHELL = [
  ...
  // 主應用邏輯
  './js/main.js',
  // 學習行為模組（版本釘定 ?v=202606110802）
  './js/chart-registry.js?v=202606110802',
  './js/behavior-loader.js?v=202606110802',
  './js/tab-behavior-radar.js?v=202606110802',
  './js/tab-behavior-correlation.js?v=202606110802',
  './js/tab-behavior-time.js?v=202606110802',
  './js/behavior-init.js?v=202606110802',
  './js/at-risk-report.js?v=202606110802',
  // CDN 備援（版本釘定）
  CHARTJS_URL,
];
