...
const BUILD_VERSION = '202606211027';
...
const APP_SHELL = [
  ...
  './js/main.js',
  './js/vendor/d3.min.js',
  './js/chart-registry.js?v=202606211027',
  './js/behavior-loader.js?v=202606211027',
  './js/tab-behavior-radar.js?v=202606211027',
  './js/tab-behavior-correlation.js?v=202606211027',
  './js/tab-behavior-time.js?v=202606211027',
  './js/tab-behavior-lsa.js?v=202606211027',
  './js/tab-behavior-cross.js?v=202606211027',
  './js/tab-behavior-warning.js?v=202606211027',
  './js/behavior-init.js?v=202606211027',
  './js/at-risk-report.js?v=202606211027',
  './js/print-panel.js?v=202606211027',
  './js/ui-toggles.js?v=202606211027',
];
